...
config_path = Path("/home/xaparo00/workspace/projects/pivotal_tokens/data/experiments/exp2.2-random-tokens-on-pivotal-positions/exp2.2.1-qwen3-1.7b-random-tokens-on-pivotal-positions/config.json")
...
pivotal_tokens_filepath = "/home/xaparo00/workspace/projects/pivotal_tokens/data//artifacts/exp2.1.4-qwen3-1.7b-pivotal-tokens.csv"
df = pd.read_csv(pivotal_tokens_filepath)
...
idx, row = list(df.loc[12:12].iterrows())[0]
