...
OUTPUT_PATH = "/home/xaparo00/workspace/projects/pivotal_tokens/data/experiments/exp3.2-sps-sentences-interventions/exp3.2.1-qwen3-1.7b-sps-sentence-interventions/data/interventions.csv"
...
def _build_metadata(
    ...
    metadata = {
        "trace_sentence_indices_original": orig_sentence_ids,
        "trace_sentence_indices_interv": ids_interv,
        "trace_token_indices_original": orig_token_ranges,
        "trace_token_indices_interv": [orig_token_ranges[sid] for sid in ids_interv],
    ...
    for sample_id, group in spans_with_order.groupby("sample_id", sort=False):
        ...
        for row in group.sort_values("_source_order").itertuples(index=False):
            ...
            base_row = {
                ...
                "pivotal_context": str(row.pivotal_context),
                "span_text": span_text,
                ...
                "pivot_sentence_position_original": pivot_idx,
...
def assemble_output_row(base_row: dict, intervention_payload: dict) -> dict:
    ...
    return {
        ...
        "metadata": json.dumps(intervention_payload["metadata"]),
    }
